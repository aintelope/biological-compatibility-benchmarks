...
def set_mem_limits(data_size, address_space_size):
    ...
    rlimits = [
        ...
        (resource.RLIMIT_AS, (int(address_space_size), int(address_space_size)))
        if address_space_size
        else None,  # The maximum area (in bytes) of address space which may be taken by the process.   # includes memory that is from shared libraries - https://stackoverflow.com/questions/7880784/what-is-rss-and-vsz-in-linux-memory-management
